...
public class Gallery3DActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 Integer[] images = { R.drawable.origin, R.drawable.bb2,
             };
    ...
    // galleryFlow.setBackgroundResource(R.drawable.line3);
     ...
     galleryFlow.setOnItemClickListener(new OnItemClickListener() {
         public void onItemClick(AdapterView<?> parent, View view,
             ...
             if(position==0){
            	 Intent intent0 = new Intent(Gallery3DActivity.this,OriginSelect.class);
            	 startActivity(intent0);
             }
             if(position==1){
            	 Intent intent1 = new Intent(Gallery3DActivity.this,ETCSelect.class);
